...
const validationSchema = Yup.object({
  ...
  images: Yup.array().of(Yup.mixed().required('Image is required'))
});
        ...
        >
          {({ setFieldValue, isSubmitting, errors }) => (
            <Form>
              ...
              <div className="mb-4">
                <label htmlFor="images" className="block text-sm font-medium text-gray-700">Upload Images (up to 4)</label>
                <input
                  type="file"
                  id="images"
                  name="images"
